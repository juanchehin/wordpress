...
<?php if ( isset( $_GET['result'] ) || isset( $_GET['action'] ) ) : ?>
	<?php if ( isset( $_GET['result'] ) && $_GET['result'] == 'failed' ): ?>
		...
		if ( ! empty( $_GET['thim_login_msg'] ) ) {
			echo sprintf( '<p class="message message-error">%s</p>', esc_html__( $_GET['thim_login_msg'], 'eduma' ) );
		}
		?>
	<?php endif; ?>
	...
	<?php if ( ! empty( $_GET['action'] ) && $_GET['action'] == 'register' ) : ?>
		<?php if ( get_option( 'users_can_register' ) ) : ?>
			...
			if ( ! empty( $_GET['thim_register_msg'] ) ) {
				echo sprintf( '<p class="message message-error">%s</p>', esc_html__( $_GET['thim_register_msg'], 'eduma' ) );
			}
			?>
			...
			<div class="thim-login form-submission-register">
				...
				<form class="<?php if ( get_theme_mod( 'thim_auto_login', true ) ) {
					...
					<p>
						<input placeholder="<?php esc_attr_e( 'Username', 'eduma' ); ?>" type="text" name="user_login"
	...
	if ( isset( $_GET['action'] ) && $_GET['action'] == 'lostpassword' ) :
		if ( ! empty( $_GET['thim_lostpass_msg'] ) ) {
			echo sprintf( '<p class="message message-error">%s</p>', esc_html__( $_GET['thim_lostpass_msg'], 'eduma' ) );
		}
		?>
	...
	<?php if ( isset( $_GET['action'] ) && $_GET['action'] == 'rp' ) : ?>
		...
		if ( ! empty( $_GET['thim_resetpass_msg'] ) ) {
			echo sprintf( '<p class="message message-error">%s</p>', esc_html__( $_GET['thim_resetpass_msg'], 'eduma' ) );
		}
		?>
