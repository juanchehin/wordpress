...
(function ($) {
	...
	var thim_course_builder = window.thim_course_builder = {
		...
		add_loading_enroll_button: function () {
            $("body.no-single-popup form.enroll-course .button-enroll-course, body.logged-in form.purchase-course .button, body.logged-in.single-popup form.enroll-course .button-enroll-course").on('click', function () {
                $(this).addClass('loading');
			});

            if ($(window).width() < 768) {
                $("body.single-popup form.enroll-course .button-enroll-course").on('click', function () {
                    $(this).addClass('loading');
                });
			};
		},
