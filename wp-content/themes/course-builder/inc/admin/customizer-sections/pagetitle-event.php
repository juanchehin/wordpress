...
thim_customizer()->add_section(
	array(
		...
		'title'    => esc_html__( 'Events: Archive Pages', 'course-builder' ),
		'priority' => 60,
	)
);
...
thim_customizer()->add_field(
	array(
		...
		'id'       => 'event_page_title_layout',
		'type'     => 'radio-image',
		'section'  => 'page_title_event',
		'priority' => 1,
		'choices'  => array(
...
thim_customizer()->add_field(
	array(
		'id'        => 'event_page_title_custom_title',
		'type'      => 'text',
...
thim_customizer()->add_field(
	array(
		'id'        => 'event_page_title_custom_description',
		'type'      => 'textarea',
...
thim_customizer()->add_field(
	array(
		'id'       => 'page_title_event_archive_background_image',
		'type'     => 'image',
