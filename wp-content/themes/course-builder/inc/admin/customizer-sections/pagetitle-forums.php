...
thim_customizer()->add_section(
	array(
		'id'       => 'page_title_forums',
		'panel'    => 'page_title_bar',
		'title'    => esc_html__( 'Forums: Archive Pages', 'course-builder' ),
		'priority' => 55,
	)
);
...
thim_customizer()->add_field(
	array(
		...
		'id'       => 'forums_page_title_layout',
		'type'     => 'radio-image',
		'section'  => 'page_title_forums',
		'priority' => 1,
		'choices'  => array(
...
thim_customizer()->add_field(
	array(
		'id'       => 'forums_page_title_show_text',
		'type'     => 'switch',
...
thim_customizer()->add_field(
	array(
		'id'        => 'forums_page_title_custom_title',
		'type'      => 'text',
...
thim_customizer()->add_field(
	array(
		'id'        => 'forums_page_title_custom_description',
		'type'      => 'textarea',
...
thim_customizer()->add_field(
	array(
		'id'       => 'page_title_forum_archive_background_image',
		'type'     => 'image',
