...
thim_customizer()->add_field(
	array(
		...
		'type'     => 'switch',
		'label' => esc_html__('Show Line After Topbar', 'megabuilder'),
		'tooltip' => esc_html__('Allows you to show or hide line between topbar and main menu.', 'megabuilder'),
		'section'  => 'header_topbar',
		'default'  => 0,
		'priority' => 40,
		'choices'  => array(
			true => esc_html__('On', 'megabuilder'),
			false => esc_html__('Off', 'megabuilder'),
		),
	)
);
