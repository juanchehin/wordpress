		...
		<?php if(!$skip_account_fields && !$pmpro_review) { ?>
			...
			<div id="pmpro_user_fields" class="pmpro_checkout">
				<h3>
					...
					<span class="pmpro_checkout-h3-msg"><?php _e('Already have an account?', 'paid-memberships-pro' );?> <a href="<?php echo add_query_arg( 'redirect_to', pmpro_url( "checkout", "?level=" . $pmpro_level->id ), thim_get_login_page_url() ); ?>"><?php _e('Log in here', 'paid-memberships-pro' );?></a></span>
				</h3>
				<div class="pmpro_checkout-fields">
